...
- manifest_ref=research/UMC/project_manifest.json
- period=2023-2024 area=서울특별시 25개 자치구
- cited_by=[]

## D002 [active]
온라인 생활세계 텍스트 13만여 건(행정동 매칭 text)
- manifest_ref=research/UMC/project_manifest.json
- period=2023-2024 area=서울 행정동(행정동 단위 매칭)
- cited_by=[]

## D003 [active]
UMC 종합지수 산출 행정자료(서울 25개 자치구·6차원 지표)
- manifest_ref=research/UMC/project_manifest.json
- period=2023-2024 area=서울특별시 25개 자치구
- cited_by=[]
